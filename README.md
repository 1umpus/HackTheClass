...
| 2 (TBD) | Linux + OSINT + OPSEC | [Challenges.](week/2/challenges) Write-up 1.|
| 3 (TBD) | Vulnerability scanning | Write-up 2. |
| 4 (TBD) | Penetration testing I | Write-up 3. |
=======
| 1 (TBD) | Introduction + Ethics + Linux | Download [VirtualBox](https://www.virtualbox.org/), [Kali](https://www.kali.org/).  [OSINT Handbook](http://www.i-intelligence.eu/wp-content/uploads/2016/11/2016_November_Open-Source-Intelligence-Tools-and-Resources-Handbook.pdf). [OPSEC](http://opsec.readthedocs.io/en/latest/). |
...
| 4 (TBD) | Penetration testing I | [HackThis](https://www.hackthis.co.uk/articles/a-beginners-guide-to-metasploit). [Mr. Robot Writeup](https://alexandervoidstar.wordpress.com/2017/01/08/ctf-writeup-mr-robot-1/). Write-up 3. |
>>>>>>> origin/master
